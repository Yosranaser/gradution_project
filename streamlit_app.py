...
with col2:
    ...
    <div style="background-color:#f2f2f2; padding:25px; border-radius:15px; text-align:right; direction:rtl;">
        <h3 style="color:#1f77b4;">👋 إزيك؟</h3>
        <p style="font-size:18px;">
        الموقع ده معمول علشان يطمنك على حالة عربيتك.
        <br>بس قبل ما نقولك المشكلة أو لو فيها حاجة، لازم الأول نتأكد إنك صاحب العربية عن طريق صورة ليك.
        </p>

        <ul style="font-size:16px;">
            <li>✅ لو العربية فيها أي مشكلة أو محتاجة صيانة، هنقولك فورًا.</li>
            <li>✅ وكمان تقدر تعرف نسبة البنزين، سرعتك، ودرجة حرارة الأجزاء المهمة.</li>
        </ul>

        <p style="font-size:17px;">
            يعني الموضوع بسيط:
            <br>➡️ خد صورة ليك الأول علشان نتأكد إنك صاحب العربية.
            <br>وبعدين نبدأ نشوف حالة العربية مع بعض.
        </p>

        <p style="font-size:17px; color:#d62728;"><b>📷 يلا خد صورة علشان نبدأ.</b></p>
    </div>
