...
#------------------------------------------------------------------------
   ...
   with col1:
    ...
    st.write(""" قبل تثبيت أي تحديث جديد للـ Firmware، يتم تحليل الملف تلقائيًا باستخدام نموذج ذكاء صناعي للكشف عن أي نمط هجوم أو تعديل غير مصرح به. هذه الخطوة تضمن سلامة النظام وتحميه من التهديدات المحتملة قبل أن يتم تحميل التحديث على وحدة التحكم.""")
