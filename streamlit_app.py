...
with col2:
    st.markdown("""
       ...
       بس قبل ما نقولك المشكلة أو لو فيها حاجة، لازم الأول نتأكد إنك صاحب العربية عن طريق صورة ليك.
        
             لو العربية فيها أي مشكلة أو محتاجة صيانة، هنقولك فورًا
             وكمان تقدر تعرف نسبة البنزين، سرعتك، ودرجة حرارة الأجزاء المهمة.
    
            يعني الموضوع بسيط:
             خد صورة ليك الأول علشان نتأكد إنك صاحب العربية.
            وبعدين نبدأ نشوف حالة العربية مع بعض.
