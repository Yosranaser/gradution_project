...
with col2:
    ...
    <div style="background-color:#f2f2f2; padding:20px; border-radius:15px; direction:rtl; text-align:right;">
        ...
        <p style="font-size:18px; color:#2ca02c;">
            ✔️ لو العربية فيها أي مشكلة أو محتاجة صيانة، هنقولك فورًا.
            <br>✔️ وكمان تقدر تعرف <b>نسبة البنزين</b>، <b>السرعة</b>، و<b>درجة حرارة الأجزاء المهمة</b>.
        </p>

        <p style="font-size:18px; color:#ff7f0e;">
